...
static void _displayPublisherAndDeveloper()
{
    ...
    ClearImage(&rect, 0, 0, 0);
    _drawImage(vs_getXY(320, 64), publisher_clut, vs_getWH(16, 1));
    _drawImage(vs_getXY(320, 0), publisher_clut + 32, vs_getWH(256 / 4, 48));
