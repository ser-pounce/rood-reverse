...
typedef struct {
    ...
    char unk186[0x1B9];
    char unk33F[65];
    char bronzeKeyObtained;
    char ironKeyObtained;
    char silverKeyObtained;
    char goldKeyObtained;
    char platinumKeyObtained;
    char steelKeyObtained;
    char crimsonKeyObtained;
    char chestKeyObtained;
    char chamomileSigilObtained;
    char lilySigilObtained;
    char tearoseSigilObtained;
    char clematisSigilObtained;
    char hyacinthSigilObtained;
    char fernSigilObtained;
    char asterSigilObtained;
    char euleliaSigilObtained;
    char melissaSigilObtained;
    char callaSigilObtained;
    char laurelSigilObtained;
    char acaciaSigilObtained;
    char palmSigilObtained;
    char kalmiaSigilObtained;
    char colombineSigilObtained;
    char anemoneSigilObtained;
    char verbenaSigilObtained;
    char schirraSigilObtained;
    char marigoldSigilObtained;
    char azaleaSigilObtained;
    char tigertailSigilObtained;
    char stockSigilObtained;
    char cattleyaSigilObtained;
    char mandrakeSigilObtained;
    char unk3A8[32];
    char unk3C0[64];
    char unk400[64];
} vs_main_flags_t;
