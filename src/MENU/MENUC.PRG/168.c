...
static int _assembleBladeMenu(int params)
{
    ...
    case 0:
        if (vs_mainmenu_ready() != 0) {
            ...
            bladeCount = 1;
            availableItems[0] = bladeToAssemble;
            ...
            for (i = 0; i < 16; ++i) {
                ...
                if ((itemId != 0) && (itemId != bladeToAssemble)) {
                    ...
                    if (blade->assembledWeaponIndex == 0) {
                        ...
                        availableItems[bladeCount] = itemId;
                        ++bladeCount;
                    }
                }
            }
        ...
        break;
    case 1:
        itemId = availableItems[_itemsListWindow + _itemsListSelection];
        if (itemId != 0) {
            func_800FD404((int)itemId);
        } else {
            func_800FBB8C(3);
            vs_mainMenu_resetStats();
            vs_mainMenu_setRangeRisk(0, 0, 0, 1);
        ...
        if (D_8010BBFC != 0) {
            ...
            if (D_8010BBFC > 0) {
                D_8010BBFC = availableItems[D_8010BBFC - 1];
            }
            state = 2;
        }
        break;
...
int _assembleGripMenu(int params)
{
    ...
    case 0:
        if (vs_mainmenu_ready() != 0) {
            ...
            gripCount = 1;
            availableItems[0] = gripToAssemble;
            ...
            for (i = 0; i < 16; ++i) {
                ...
                if ((itemId != 0) && (itemId != gripToAssemble)) {
                    ...
                    if (grip->assembledWeaponIndex == 0) {
                        ...
                        availableItems[gripCount] = itemId;
                        ++gripCount;
                    }
                }
            }
    ...
    case 1:
        ...
        if (D_8010BC04 != 0) {
            ...
            if (D_8010BC04 > 0) {
                D_8010BC04 = availableItems[D_8010BC04 - 1];
            }
            state = 2;
        }
        break;
...
static int _attachGem(int params)
{
            ...
            for (i = 0; i < 48; ++i) {
                ...
                if ((itemId != 0) && (itemId != gemToAttach)) {
                    ...
                    if (gem->setItemIndex == 0) {
                        ...
                        availableItems[gemCount] = itemId;
                        ++gemCount;
                    }
                }
            }
    ...
    case 1:
        ...
        if (D_8010BC0C != 0) {
            ...
            if (D_8010BC0C > 0) {
                D_8010BC0C = availableItems[D_8010BC0C - 1];
            }
            state = 2;
        }
        break;
...
static int _attachGemsMenu(int arg0)
{
    ...
    case 3:
        if (vs_mainmenu_ready() != 0) {
            ...
            var_s2 = availableItems[selectedRow];
...
static int _disassembleMenu(int arg0)
{
            ...
            for (i = 0; i < 8; i++) {
                if (isShield != 0) {
                    ...
                    if (selectedItem != 0) {
                        ...
                        ++count;
                        availableItems[count] = selectedItem;
                    }
                } else {
    ...
    case 3:
        ...
        _copyMenuItem(selectedRow + 9, 10);
        selectedItem = availableItems[selectedRow];
...
static int _renameWeaponMenu(int arg0)
{
    ...
    case 3:
        if (vs_mainmenu_ready() != 0) {
            ...
            _copyMenuItem(0, 32);
            _copyMenuItem(selectedRow + 9, 10);
            itemId = availableItems[selectedRow];
...
static void func_80107894(int arg0)
{
    int i;
    int var_s3;
    u_int temp_v1;
...
static int _selectBlade(int arg0)
{
    ...
    case 1:
        ...
        if (selectedRow != 0) {
            ...
            if (selectedRow > 0) {
                selectedRow = availableItems[selectedRow - 1];
            }
            state = 2;
        }
        break;
...
static int _selectShield(int arg0)
{
    ...
    case 1:
        ...
        if (D_8010BC68 != 0) {
            ...
            if (D_8010BC68 > 0) {
                D_8010BC68 = availableItems[D_8010BC68 - 1];
            }
            state = 2;
        }
        break;
...
int func_801099FC(int arg0)
{
    ...
    case 1:
        ...
        if (D_8010BC74 != 0) {
            ...
            if (D_8010BC74 > 0) {
                D_8010BC74 = availableItems[D_8010BC74 - 1];
            }
            D_8010BC78 = 2;
        }
        break;
...
int _combineArmorMenu(int arg0)
{
    ...
    case 5:
        ...
        case 1:
            ...
            itemId = D_8010BD7C[0];
            var_s3 = &vs_battle_inventory.armor[itemId - 1];
