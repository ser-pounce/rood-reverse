...
void func_80073D30(D_800F1910_t2*, int*, int);
void func_80073E30(D_800F1910_t2*, int);
...
void func_8006AC74(func_8006AC74_t* arg0, func_8006AC74_t* arg1)
{
    int i;
...
void func_8006B214(void)
{
    ...
    if (temp_s0->unk948 & 0x100000) {
        func_80093FEC(temp_s0->flags.u8[3], 0, 0x100000, 1);
...
void func_8006B270(void)
{
    ...
    if (temp_a2 != 0) {
        func_80093FEC(temp_s0->flags.u8[3], 0, temp_a2, 1);
...
void func_8006F450(func_8006F450_t* arg0)
{
    func_8006F450_t sp10;
    ...
    sp10.unk8 = 0;
    sp10.unk10 = 5;
    sp10.unk14 = arg0->unk0;
    sp10.unk18 = arg0->unk4;
    sp10.unk16 = 0;
    func_800CF3F8((func_800CF3F8_t*)&sp10, 0);
}

void func_8006F4B0(func_8006F450_t* arg0)
{
    func_8006F450_t sp10;
    ...
    sp10.unk8 = 0;
    sp10.unk10 = 5;
    sp10.unk14 = ((char)arg0->unk0 << 7) + 0x40;
    sp10.unk18 = (arg0->unk2 << 7) + 0x40;
    sp10.unk16 = arg0->unk6;
    if (!(D_800F1868 & 2)) {
        func_800CF3F8((func_800CF3F8_t*)&sp10, 0);
    }
}
...
int func_80074120(void)
{
    ...
    sp10.unk0 = D_800F1910.unk8;
    sp10.unk2 = D_800F1910.unkA;
    sp10.unk4 = D_800F1910.unkC;
...
void func_800741D4(void)
{
    ...
    if (D_800F196C == 8) {
        ...
        func_80073D30(D_800F1910.unk0, &D_800F1910.unk4, D_800F1910.unk10);
        return;
    }
    func_80073E30(D_800F1910.unk0, D_800F1910.unk10);
}
...
void func_800742A4(void)
{
    ...
    vs_gametime_tickspeed = 2;
    v = 7;
    sp10[0] = (D_800F1910.unk0->unk0 << v) + 0x40;
    sp10[2] = (D_800F1910.unk0->unk2 << v) + 0x40;
...
void func_80074314(void)
{
    ...
    vs_gametime_tickspeed = 2;
    func_800CB50C();
    func_8008DEAC(D_800F1910.unk0, 1);
    func_800E68EC(D_800F1910.unk0->unk0, D_800F1910.unk0->unk2);
}
...
{
    func_800C97BC();
    if ((*func_800CB66C() != 1) && (func_800CB45C() == 0)) {
        func_8006C40C();
        func_800CB114();
        func_800CB50C();
        func_8006F89C();
...
int func_8007F1A4(int arg0, int arg1, func_8007F1A4_t* arg2)
{
    int var_v0;

    var_v0 = ((0xFF - vs_battle_actors[arg2->unk0]->unk3C->hitLocations[arg2->unk1].unk7)
                 * 0x64)
           / 255;
    if (var_v0 == 255) {
        var_v0 = 254;
...
{
    if (D_800F1CA0 != NULL) {
        D_800F1CA0[arg0][1] = (D_800F1CA0[arg0][1] & (~0xFE)) | ((arg1 & 0x7F) * 2);
...
void func_8008DEAC(D_800F1910_t2* arg0, int arg1)
{
    if (arg0 == NULL) {
        ...
        if (var_a2 != NULL) {
            int i;
            int temp_a3 = D_800F1BF8.unk4[8] / 12;
            for (i = 0; i < temp_a3; ++i) {
                var_a2->unkA = arg1;
                ++var_a2;
            }
