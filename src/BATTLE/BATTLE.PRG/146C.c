...
void func_8006BAA8(int arg0, u_short* arg1)
{
    if (arg1[0] != 0) {
        arg1[4] = arg1[24];
        func_8006B7BC();
...
void func_800770FC(int arg0, int arg1)
{
...
short func_8008381C(int arg0, u_char* arg1) { return D_800F1928[*arg1]->unk3C->unkAC; }
