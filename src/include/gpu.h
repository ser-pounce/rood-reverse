...
enum vs_primType {
    ...
    primPolyGT4 = 0x3C,
    primPolyGT4SemiTrans = primPolyGT4 | primSemiTrans,
    primLineF2 = 0x40,
    primLineF2SemiTrans = primLineF2 | primSemiTrans,
    primLineG2 = 0x50,
    primLineG2SemiTrans = primLineG2 | primSemiTrans,
    primTile = 0x60,
...
#define vs_getUV1Tpage(u, v, x, y, tp, abr)                                              \
    (((u) | ((v) << 8)) | (getTPage((tp), (abr), (x), (y)) << 16))
