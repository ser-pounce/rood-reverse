...
#pragma vsstring(end)
    ...
    case 5:
        ...
        func_800C7210(5);
        i = vs_battle_toBCD(D_8010966F);
        vs_battle_printDialogChar(i & 0xF, 0x42, 0x82, D_1F800000[2] - 12);
        i = vs_battle_toBCD(i >> 4);
        vs_battle_printDialogChar(i & 0xF, 0x3C, 0x82, D_1F800000[2] - 12);
        vs_battle_printDialogChar(i >> 4, 0x36, 0x82, D_1F800000[2] - 12);
        D_8010961F =
