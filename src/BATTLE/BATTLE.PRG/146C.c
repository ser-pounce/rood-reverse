...
int func_8007F518(int);

int func_8007F568(int arg0 __attribute__((unused)), int arg1)
{
    return func_8007F518(arg1) == 2;
}

int func_8007F58C(int arg0 __attribute__((unused)), int arg1)
{
    return func_8007F518(arg1) != 2;
}
...
{
    return D_800F1928[*arg2]->unk3C[8];
}
