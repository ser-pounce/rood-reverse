...
void func_800A97EC(int arg0, u_char* arg1, int arg2, int arg3)
{
    ...
    if (arg2 == 0 && arg3 == 0) {
        ...
        *(short*)((char*)actor + 0x5EC) = (arg1[0] << 7) + 0x40;
        *(short*)((char*)actor + 0x5F0) = (arg1[2] << 7) + 0x40;
        *(short*)((char*)actor + 0x5EE) =
            func_800A6EE8((short*)((char*)actor + 0x5EC), 0, 0, 1);
        angle = 0x8000;
        if (arg1[3] == 0xFF) {
            *(u_short*)((char*)actor + 0x5F2) = angle;
        } else {
            *(u_short*)((char*)actor + 0x5F2) = arg1[3] << 4;
        }
        actor->unk5AC_0 = 1;
        actor->unk5AC_2 = 0;
    }
...
INCLUDE_ASM("build/src/BATTLE/BATTLE.PRG/nonmatchings/40564", func_800A9E38);
...
INCLUDE_ASM("build/src/BATTLE/BATTLE.PRG/nonmatchings/40564", func_800AA218);
...
INCLUDE_ASM("build/src/BATTLE/BATTLE.PRG/nonmatchings/40564", func_800ACFA0);
